...
* **Divination & Ritual (占卜與儀式感):** An intuitive divination process including immersive Six-Line Coin Divination (金錢卦) with a modern aesthetic. / 提供直覺且具備沉浸感的金錢卦起卦流程。
...
* **Backend:** Cloudflare Workers (API Proxy & KV Cache)
* **State Management:** Riverpod
* **AI Engine:** Google Gemini (Direct / Proxy)
